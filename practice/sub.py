...
# plt.subplot(2, 2, 1)
# plt.bar(months, anudeep, color='blue', label='Anudeep')
...
# plt.subplot(2, 2, 2)
# plt.bar(months, aneek, color='green', label='Aneek')
...
# plt.subplot(2, 2, 3)
# plt.bar(months, souporno, color='red', label='Souporno')
...
# plt.subplot(2, 2, 4)
# plt.bar(months, arya, color='purple', label='Arya')
...
# plt.subplot(2, 2, 1)
# df.plot(x='months', y='anudeep', kind='line', marker='o', color='blue', label='Anudeep')
# plt.title('Anudeep Sales Data')
# plt.xlabel('Month')
# plt.ylabel('Sales Units')
...
# plt.subplot(2, 2, 2)
# df.plot(x='months', y='aneek', kind='line', marker='o', color='green', label='Aneek')
# plt.title('Aneek Sales Data')
# plt.xlabel('Month')
# plt.ylabel('Sales Units')
...
# plt.subplot(2, 2, 3)
# df.plot(x='months', y='souporno', kind='line', marker='o', color='red', label='Souporno')
# plt.title('Souporno Sales Data')
# plt.xlabel('Month')
# plt.ylabel('Sales Units')
...
# plt.subplot(2, 2, 4)
# df.plot(x='months', y='arya', kind='line', marker='o', color='purple', label='Arya')
# plt.title('Arya Sales Data')
# plt.xlabel('Month')
# plt.ylabel('Sales Units')
