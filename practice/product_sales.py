...
plt.plot(mounths, Face_Cream_sales, marker='o', label='Face Cream Sales')
plt.plot(mounths, Face_Wash_sales, marker='o', label='Face Wash Sales')
plt.plot(mounths, Toothpaste_sales, marker='o', label='Toothpaste Sales')
plt.plot(mounths, Shampoo_sales, marker='o', label='Shampoo Sales')
plt.plot(mounths, Conditioner_sales, marker='o', label='Conditioner Sales')
plt.plot(mounths, Deodorant_sales, marker='o', label='Deodorant Sales')
...
# plt.scatter(mounths, Face_Cream_sales, color='red', label='Toothpaste Sales')
